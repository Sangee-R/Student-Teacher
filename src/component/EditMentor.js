...
export default function EditMentor(props) {
    ...
    document.title = "Edit Mentor Details";
    var {id} = useParams();
    id = parseInt(id);
    let a = props.mentors;
    ...
    const handleSubmit = (e) => {
        ...
        editMentor(id, mentor);
    }
    const editMentor = (id, mentor) => {
        let prev = props.mentors;
        prev[id] = mentor;
        props.setMentors(prev);
        cookies.remove('data', { path: '/' });
        cookies.set('data', prev, { path: '/' });
        props.showAlert('success', 'Mentor updated successfully');
        
        Navigate('/display-mentor');
      }
    ...
    return (
        <div className="container">
            <h1 className='text-center mb-5'>Edit Mentor Details</h1>
